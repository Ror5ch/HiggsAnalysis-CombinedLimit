...
class HZZAnomalousCouplingsFromHistogramsNonSMEFT(MultiSignalSpinZeroHiggs):
    ...
    def getPOIList(self):
        ...
        self.modelBuilder.doVar('RV_HTT[1,0,10]')
        self.modelBuilder.doVar('RF_HTT[1,0,10]')

        self.modelBuilder.out.var("RV_HTT").setConstant(False)
        self.modelBuilder.out.var("RV_HTT").setAttribute("flatParam")
        self.modelBuilder.out.var("RF_HTT").setConstant(False)
        self.modelBuilder.out.var("RF_HTT").setAttribute("flatParam")
