...
class HZZAnomalousCouplingsFromHistogramsNonSMEFT(MultiSignalSpinZeroHiggs):
    ...
    def getPOIList(self):
        ...
        self.modelBuilder.factory_('expr::muVc("@1/(1+500.*abs(@0))", CMS_zz4l_fai3, RV)'.format(**HZZAnomalousCouplingsFromHistogramsNonSMEFT.xsecs_HTT))
    ...
    def getYieldScale(self,bin,process):
        ...
        if process in ["embedded", "ZL", "TTL", "VVL", "STL", "jetFakes", "qqH_hww125", "ZH_hww125"]:
            return 1.
        if process in ["reweighted_ggH_htt_0PM"]:
            return 1.
